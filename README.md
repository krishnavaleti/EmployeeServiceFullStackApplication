# This is a full-stack application is developed with Spring Boot as backend and React as frontend, integrated with Kafka and Zookeeper for event-driven architecture.
